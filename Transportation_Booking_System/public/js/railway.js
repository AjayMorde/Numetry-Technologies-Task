...
function submitData(event) {
    ...
    let userprice = prices[railwaySelect.value];
    ...
    console.log('====================================>', date, state, city, railway, time, payment, price, ac, passenger, other)
...
async function sendData(data, price) {
    try {
        ...
        const res = await axios.post('railway/railway-booking', data, { headers: { "Authorization": token } })
        if (res.status == 200) {
            ...
            <p>If you wish to cancel your railway booking, you can do so by accessing the  <strong>Your railway Tickets Bookings</strong> options. Feel free to delete your booking now.</p>
